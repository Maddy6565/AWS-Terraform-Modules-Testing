...
module "aws_route_table_association_a" {
...
module "aws_route_table_association_b" {
...
module "security_group_a" {
  ...
  security_group_description = "Security Group A for EC2"
...
module "security_group_b" {
  ...
  security_group_description = "Security Group B for EC2"
